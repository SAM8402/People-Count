...
email_sender = 'imran2021cs107@abesit.edu.in'
email_recipient = 'imranashraf65640@gmail.com'
        ...
        for i, det in enumerate(pred):
          ...
          if len(det):
            ...
            for c in det[:, -1].unique():
              ...
              # c == 2 means safe
              # if unsafe == False and (c == 0 or c == 1 or c == 3) and n > 3:
              #   unsafe = True
            ...
            if n > 3 and is_email_allowed == True:
              violation_frames += 1
